...
<head>
    ...
    <link href="//install.jsmart.ru/assets/css/normalize.css?<?=$time?>" rel="stylesheet">
    <link href="//install.jsmart.ru/assets/css/main.css?<?=$time?>" rel="stylesheet">
    <script src="//install.jsmart.ru/assets/js/jquery.js?<?=$time?>"></script>
    <script src="//install.jsmart.ru/assets/js/main.js?<?=$time?>"></script>
